...
class MessageBoardView(BrowserPagelet):
    ...
    def update(self):
        ...
        self.topics = Batch(
            BTreeSequence(context), start=bstart, size=context.page_size)

    def allowAddTopic(self):
        return checkPermission('zojax.AddContent', self.context)
